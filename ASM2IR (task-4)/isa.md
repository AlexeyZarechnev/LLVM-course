...
* `gep2 arg0 arg1 arg2 arg3 arg4 arg5 arg6` - получает указатель на нужный элемент: `arg0` регистр для записи результата, `arg1` константа (размер 2 измерения массива), `arg2` указатель на массив, `arg3` `arg4` индексы, `arg5` `arg6` оффсеты для индексов
