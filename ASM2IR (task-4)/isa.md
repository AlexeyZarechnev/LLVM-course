...
`sp` - особый регистр (stack-pointer) содержит в себе указатель на стек

## Работа с указателями

* `gep2 arg0 arg1 arg2 arg3 arg4 arg5 arg6` - получает указатель на нужный элемент: `arg0` регистр для записи результата, `arg1` константа (размер 1 измерения массива), `arg2` указатель на массив, `arg3` `arg4` индексы, `arg5` `arg6` оффсеты для индексов
* `load arg0 arg1` - загружает значение по указателю: `arg0` регистр для записи результата, `arg1` указатель на элемент
* `store arg0 arg1` - сохраняет значение по указателю: `arg0` указатель для записи результата, `arg1` значение
...
* `FILL_INIT_STATE arg0` - `arg0` сохраняет результат
